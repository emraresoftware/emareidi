...
```python
# Emare IDI — Yetki Tanımları
PROJE_PERMISSIONS = [
    # Temel
    'emareidi.view',      # Görüntüleme
    'emareidi.create',    # Oluşturma
    'emareidi.edit',      # Düzenleme
    'emareidi.delete',    # Silme
    'emareidi.manage',    # Tam yönetim
    # Admin
    'emareidi.admin',     # Admin panele erişim
    'emareidi.users',     # Kullanıcı yönetimi
    'emareidi.settings',  # Ayar yönetimi
]
```
...
```python
# emareidi/auth/rbac.py — Kopyala, uyarla, kullan.
...
PERMISSIONS = {
    'super_admin': {'*'},
    'admin': {
        'emareidi.view', 'emareidi.create',
        'emareidi.edit', 'emareidi.delete',
        'emareidi.manage', 'emareidi.users',
        'emareidi.settings', 'emareidi.admin',
    },
    'operator': {
        'emareidi.view', 'emareidi.create',
        'emareidi.edit',
...
| Proje Admini | admin@emareidi.emare.dev | admin | Proje yöneticisi |
| API Servisi | api@emareidi.emare.dev | super_admin | Machine-to-machine |
