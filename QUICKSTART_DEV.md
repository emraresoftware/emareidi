# Emare IDI — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/emareidi
...
| 6 | `emareidi_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `emareidi Dervishi` bu projeden sorumlu
